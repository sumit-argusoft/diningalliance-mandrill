 ...
 * @package diningalliance/yii2-mandrill
 * @author Nicola Puddu <n.puddu@outlook.com>
 */

namespace diningalliance\mandrill;
...
class Message extends BaseMessage
{
     ...
     *
     * @see \diningalliance\mandrill\Message::setFrom() setter
     * @see \diningalliance\mandrill\Message::getFrom() getter
     *
     * @var string
     */
     ...
     *
     * @see \diningalliance\mandrill\Message::setTo() setter
     * @see \diningalliance\mandrill\Message::getTo() getter
     *
     * @var array
     */
    private $_to = [];
     ...
     *
     * @see \diningalliance\mandrill\Message::setReplyTo() setter
     * @see \diningalliance\mandrill\Message::getReplyTo() getter
     *
     * @var array
     */
    private $_replyTo = [];
     ...
     *
     * @see \diningalliance\mandrill\Message::setCc() setter
     * @see \diningalliance\mandrill\Message::getCc() getter
     *
     * @var array
     */
    private $_cc = [];
     ...
     *
     * @see \diningalliance\mandrill\Message::setBcc() setter
     * @see \diningalliance\mandrill\Message::getBcc() getter
     *
     * @var array
     */
    private $_bcc = [];
     ...
     *
     * @see \diningalliance\mandrill\Message::setTags() setter
     * @see \diningalliance\mandrill\Message::getTags() getter
     *
     * @var array
     */
    private $_tags = [];
     ...
     *
     * @see \diningalliance\mandrill\Message::setSubject() setter
     * @see \diningalliance\mandrill\Message::getSubject() getter
     *
     * @var string
     */
    private $_subject;
     ...
     *
     * @see \diningalliance\mandrill\Message::setTextBody() setter
     * @see \diningalliance\mandrill\Message::getTextBody() getter
     *
     * @var string
     */
    private $_text;
     ...
     *
     * @see \diningalliance\mandrill\Message::setHtmlBody() setter
     * @see \diningalliance\mandrill\Message::getHtmlBody() getter
     *
     * @var string
     */
    private $_html;
     ...
     * ~~~
     *
     * @see \diningalliance\mandrill\Message::attach() setter
     * @see \diningalliance\mandrill\Message::getAttachments() getter
     *
     * @var array
     */
     ...
     * ~~~
     *
     * @see \diningalliance\mandrill\Message::embed() setter
     * @see \diningalliance\mandrill\Message::getEmbeddedContent() getter
     *
     * @var array
     */
    private $_images = [];
     ...
     *
     * @see \diningalliance\mandrill\Message::setCharset() setter
     *
     * @return null
     */
     ...
     * Mandrill does not let users set a charset.
     *
     * @see \diningalliance\mandrill\Message::getCharset() getter
     *
     * @param string $charset character set name.
     * @return \diningalliance\mandrill\Message
     */
     ...
     *
     * @see \diningalliance\mandrill\Message::attach() setter for file name
     * @see \diningalliance\mandrill\Message::attachContent() setter for binary
     *
     * @return array
     */
    ...
    public function attach($fileName, array $options = []) {
        ...
        $this->_contentType = $headers[7];
        if ($headers[0]=="HTTP/1.1 200 OK") {


            $purifiedOptions = [
                'fileName' => ArrayHelper::getValue($options, 'fileName', basename($fileName)),
                'contentType' => ArrayHelper::getValue($options, 'contentType', $this->_contentType),
            ];
    ...
    public function attachContent($content, array $options = []) {
        ...
        if (is_string($content) && strlen($content) !== 0) {
            ...
            $this->_attachments[] = [
                ...
                'type' => ArrayHelper::getValue($purifiedOptions, 'contentType', $this->_contentType),
     ...
     *
     * @see \diningalliance\mandrill\Message::embed() setter for file name
     * @see \diningalliance\mandrill\Message::embedContent() setter for binary
     *
